module github.com/incidentary/opentelemetry-collector-incidentary

go 1.25.0

// The Incidentary Bridge: a contrib-shaped OpenTelemetry collector
// processor + standalone sidecar.

require (
	github.com/incidentary/incidentary-go-core v0.1.0
